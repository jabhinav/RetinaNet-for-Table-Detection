...
class RoiResizeConv(Layer):
    ...
    def call(self, x, mask=None):
        ...
        # x is [pooling_input, roi_input]
        img = x[0] # pooling_input = base_model.output
        rois = x[1] # roi with shape (num_rois,4) with ordering (x1,y1,x2,y2)
...
class Scale(Layer):
    ...
    the output simply consists of an element-wise multiplication of the input
